...
from products.views import ProductAPIDestroy, ProductAPIUpdate, ProductAPIList, LessonAPIList

urlpatterns = [
    path('admin/', admin.site.urls),
    path('api/v1/drf-auth/', include('rest_framework.urls')),
    path('api/v1/product/', ProductAPIList.as_view()),
    path('api/v1/lesson/', LessonAPIList.as_view()),  # маршрут API с выведением списка уроков по конкретному продукту
